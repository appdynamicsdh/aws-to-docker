...
public class WelcomeController {
	...
	public String info() {
		...
		return DockerHttpApiData.getDataForUrl("/info");
	}

	@GetMapping("/containers/json")
	public String containersJson() {
		return DockerHttpApiData.getDataForUrl("/containers/json");
	}

	@GetMapping("/containers/{containerId}/json")
	public String containerJson() {
		return DockerHttpApiData.getDataForUrl(DockerHttpApiData.CONTAINER_URL);
	}

	@GetMapping("/containers/{containerId}/top")
	public String containers(@PathVariable String containerId) {
		return DockerHttpApiData.getDataForUrl("/containers/"+DockerHttpApiData.DEFAULT_CONTAINER_ID+"/top?ps_args=aux");
	}
	@GetMapping("/images/{containerId}/json")
	public String images(@PathVariable String containerId){
		return DockerHttpApiData.getDataForUrl("/images/"+DockerHttpApiData.DEFAULT_CONTAINER_ID+"/json");
	}
